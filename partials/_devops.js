            ...
            <div class="modal">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <iframe width="560" height="315" src="${presentLink}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
               </div>
            </div>
         `;
                        ...
                        <div class="card-back">
                           ...
                           <div class="play">
                              ...
                              <div class="play-btn row center">
                                 <div class="btn btn-primary" onclick="openModal('${present.presentLink}')">Play</div>
                              </div>
                           </div>
                           <div class="card-links">
                              <a href="${present.presentView}" target='_blank'><div class="btn btn-primary">View Project</div></a>
                              <a href="${present.presentCode}" target='_blank'><div class="btn btn-primary">View Code</div></a>
                           </div>
                        </div>
                     </div>
                  </div>
